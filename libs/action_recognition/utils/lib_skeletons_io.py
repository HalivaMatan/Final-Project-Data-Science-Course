...
def get_training_imgs_info(
    ...
    with open(valid_images_txt) as f:
        ...
        for cnt_line, line in enumerate(f):
            ...
            images = glob.glob("data\source_images3\{}\*.jpg".format(action_label))

            print("data\source_images3\{}\*.jpg".format(action_label))

            # print("Line {}, len ={}, images: {}".format(line, len(line), images))
            
            if len(images) > 0:  # line != "\n"
                ...
                for filename in images:
                    ...
                    image_info = [cnt_action, cnt_clip,
                                  cnt_image, action_label, filename]
...
class ReadValidImagesAndActionTypesByTxt(object):
    ...
    def imread(self, index):
        print(self.get_filename(index))
        return cv2.imread(self.get_filename(index))
