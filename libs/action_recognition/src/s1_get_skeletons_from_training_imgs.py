...
if __name__ == "__main__":
    ...
    print(SRC_IMAGES_FOLDER, SRC_IMAGES_DESCRIPTION_TXT, IMG_FILENAME_FORMAT)
    ...
    for ith_img in range(num_total_images):
        ...
        filename = "{}.txt".format(str(img_info[1]))
        ...
        print("imwrite")
        print(DST_VIZ_IMGS_FOLDER + filename)
        cv2.imwrite(
            DST_VIZ_IMGS_FOLDER + filename,
            img_disp)

        # print(f"{filename}/{num_total_images} th image "
